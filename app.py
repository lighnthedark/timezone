...
CITIES = {
    ...
    'San Jose, Costa Rica': {'timezone': 'America/Costa_Rica', 'currency': 'CRC', 'lat': 9.93, 'lon': -84.08},
    'Medellin, Colombia': {'timezone': 'America/Bogota', 'currency': 'COP', 'lat': 6.25, 'lon': -75.56},
    'Buenos Aires, Argentina': {'timezone': 'America/Argentina/Buenos_Aires', 'currency': 'ARS', 'lat': -34.60, 'lon': -58.38},
    'Bangkok, Thailand': {'timezone': 'Asia/Bangkok', 'currency': 'THB', 'lat': 13.76, 'lon': 100.50},
    'Kuala Lumpur, Malaysia': {'timezone': 'Asia/Kuala_Lumpur', 'currency': 'MYR', 'lat': 3.14, 'lon': 101.69},
    'Bali, Indonesia': {'timezone': 'Asia/Makassar', 'currency': 'IDR', 'lat': -8.41, 'lon': 115.19},
    'Manila, Philippines': {'timezone': 'Asia/Manila', 'currency': 'PHP', 'lat': 14.60, 'lon': 120.98},
